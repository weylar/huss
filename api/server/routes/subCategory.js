...
subCategoryRouter.get('/:categoryName/getAllSubCategories', getAllSubCategories);
subCategoryRouter.get('/:categoryName/getAllSubCategoriesByLimit/:limit', getAllSubCategoriesByLimit);
