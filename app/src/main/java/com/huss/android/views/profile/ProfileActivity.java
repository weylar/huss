...
public class ProfileActivity extends AppCompatActivity implements NetworkReceiverUtil.ConnectivityReceiverListener {
    ViewPager vpPager;
    TabLayout tabLayout;
...
//                .onto(root);
    ...
    private void getAdsDetails() {
        ...
        userAdsViewModel.getUserAds().observe(this, ads -> {
            ...
            totalAdsCount.setText(SingleAdsActivity.formatViews(ads.getData().size() + ""));
            totalActiveAdsCount.setText(SingleAdsActivity.formatViews(activeCount + ""));
            totalInActiveAdsCount.setText(SingleAdsActivity.formatViews(inactiveCount + ""));
    ...
    public void onNetworkConnectionChanged(boolean isConnected) {
        if (!isConnected){
            snackbar = Snackbar.make(name, "No internet connection", Snackbar.LENGTH_INDEFINITE);
            snackbar.show();
        }else{
            if (snackbar != null) {
                snackbar.dismiss();
